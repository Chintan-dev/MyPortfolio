...
import my_pic from '../img/my_img.jpg';

const linkedin = '#';
const instagram = 'https://www.instagram.com/chintan_patel.dev';
const github = 'https://github.com/Chintan-dev';
...
export default function Sections() {
    return (
        <>
                ...
                <div className='social-media-icon'>
                    ...
                    <icon>
                        <a href={github} target="_blank">
                            <svg width="25" height="25" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
            ...
            <section id='section-Skills' className='section-Skills'>
                <div className='Skills'>
                    <div className='skills-box-1'>
                        <div className=''>
                            <svg className='svg' viewBox="0 0 124 141.53199999999998">
                                <path d="M10.383 126.894L0 0l124 .255-10.979 126.639-50.553 14.638z" fill="#e34f26" />
                                <path d="M62.468 129.277V12.085l51.064.17-9.106 104.851z" fill="#ef652a" /><path d="M99.49 41.362l1.446-15.49H22.383l4.34 47.49h54.213L78.81 93.617l-17.362 4.68-17.617-5.106-.936-12.085H27.319l2.128 24.681 32 8.936 32.255-8.936 4.34-48.17H41.107L39.49 41.362z" fill="#fff" />
                            </svg>
                        </div>
                        <div className=''>
                            <svg className='svg' fill="none" viewBox="0 0 124 141.53">
                        ...
                        <div className=''>
                            <svg className='svg' viewBox="0 0 1052 1052">
            ...
            <section id='section-Servies' className='section-Servies'>
